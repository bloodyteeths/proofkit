#!/usr/bin/env python3
"""Test Free Tier Certificate Generator using actual core renderer"""
...
def generate_free_tier_certificate():
    """Generate Free tier certificate using core renderer with QR codes."""
    ...
    # Create spec object
    job = SimpleNamespace(job_id="FREE_TIER_TEST")
    ...
    output_path = "certificate_FREE_TIER_FAIL.pdf"
    pdf_bytes = generate_certificate_pdf(
        spec, 
        decision, 
        plot_path="data/temperature_plot.png",
        verification_hash="free_tier_test_hash_fail_" + str(hash(str(decision_data))),
...
if __name__ == "__main__":
    try:
        output_path = generate_free_tier_certificate()
        print(f"✅ Free Tier certificate generated: {output_path}")
        print("   Features: Fixed micro-text borders, clean footer")
